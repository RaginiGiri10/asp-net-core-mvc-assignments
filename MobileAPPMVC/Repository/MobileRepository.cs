...
namespace MobileAPPMVC.Repository
{
    public class MobileRepository:IMobileRepository
    {
        ...
        {
            return _mobileDbContext.Mobiles.Include(d => d.Manufacturer).ToList();
        }

        public Mobile GetFullMobileDetailsById(int id)
        {
            var existingMobile = _mobileDbContext.Mobiles.Include(d => d.Manufacturer).FirstOrDefault(e => e.Id == id);
        ...
        public void UpdateMobile(int id, Mobile mobile)
        {
            ...
            if (existingMobile != null)
            {
                ...
                existingMobile.Amount = mobile.Amount;
                _mobileDbContext.SaveChanges();
            }
